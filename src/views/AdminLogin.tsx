      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="mx-auto w-32 h-18 rounded-full flex items-center justify-center overflow-hidden">
            {logo ? (
              <img src={logo} alt="Brand logo" className="w-30 h-auto object-contain" />
            ) : (
              <img src="https://res.cloudinary.com/dglumbcje/image/upload/v1766763015/saabz_kitchen/0769bd28-050c-4886-a8f6-d3714a683ce2.png" className="w-30 h-auto object-contain" />
            )}
          </div>
          <CardTitle>{isSignUp ? "Create Account" : "Admin Login"}</CardTitle>
          <CardDescription>{isSignUp ? "Sign up request" : "Sign in to access admin"}</CardDescription>
        </CardHeader>
