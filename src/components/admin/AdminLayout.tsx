          ...
          <div className="p-6 border-b border-border">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full flex items-center justify-center overflow-hidden">
                {logo ? (
                  <img src={logo} className="object-contain w-full h-full" alt="Admin Logo" />
                ) : (
              ...
              <div>
                {brandImage && <img src={brandImage} className="h-6 w-auto object-contain mb-1" alt="Brand" />}
                <span className="font-display text-lg text-chocolate block">Saabz Kitchen</span>
